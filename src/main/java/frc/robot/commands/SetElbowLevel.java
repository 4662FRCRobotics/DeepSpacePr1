...
public class SetElbowLevel extends Command {

  private ArmSetPoint m_ElbowLevel;

  public SetElbowLevel(ArmSetPoint elbowLevel) {
    requires(Robot.m_elbowJoint);
    m_ElbowLevel = elbowLevel;
  }
  ...
  protected void initialize() {
    ...
    Robot.m_elbowJoint.setArmLevel(m_ElbowLevel);
  }
